...
list_file = io.open(FILE_LIST, 'r', encoding='utf8')
filenames = []
...
for i in range(number_of_entries):
    ...
    real_size = os.path.getsize(os.path.join(output_dir, filenames[i].rstrip('\n')))
    ...
    src_file = open(os.path.join(output_dir, filenames[i].rstrip('\n')), 'rb')
